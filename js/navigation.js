...
jQuery(document).ready(function() {
    if (jQuery(window).width() < 991) {
        var sidebarDocs = jQuery(".sidebar-docs"),
            spoilerDocs = jQuery(".spoiler-docs"),
            turnBtnDocs = jQuery(".turn-btn-docs");

        turnBtnDocs.click(function() {
            jQuery(this).toggleClass("active");
            sidebarDocs.toggleClass("open-btn");
            spoilerDocs.toggleClass("hiddendark");
            jQuery("body").toggleClass("scrollnone");
        });
        spoilerDocs.click(function(e){
            if(jQuery(event.target).hasClass('spoiler-docs')){
                turnBtnDocs.removeClass("active");
                sidebarDocs.removeClass("open-btn");
                jQuery(this).removeClass("hiddendark");
                jQuery("body").removeClass("scrollnone");
            }
        });
    };
