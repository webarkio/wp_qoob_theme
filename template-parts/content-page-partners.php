...
<div id="primary" class="content-area container main-partners">
	<main id="main" class="site-main-partners" role="main">
		<article id="post-<?php the_ID(); ?>" <?php post_class( 'col-lg-12 col-md-12 col-sm-12 col-xs-12 page-partners' ); ?>>
